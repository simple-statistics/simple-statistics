...
test("approximate strict equality", function (t) {
    ...
    t.test("handles negative values", function (t) {
        ...
        t.true(ss.approxStrictEqual(-10 - EPS, -10));
        t.true(!ss.approxStrictEqual(-10 - 11 * EPS, -10));
        t.true(!ss.approxStrictEqual(-10, 10));
        t.end();
    });

    t.test("handles larger tolerances", function (t) {
        t.true(!ss.approxStrictEqual(1, 2));
        t.true(ss.approxStrictEqual(1, 2, 1.5));
        t.end();
    });

    t.test("handles values near zero", function (t) {
        t.true(!ss.approxStrictEqual(1, 0));
        t.true(!ss.approxStrictEqual(0, 1));
        t.end();
    });
