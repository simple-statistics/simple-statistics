...
describe("quantile", function () {
    ...
    it("array of quantiles is independent of which quantiles are requested (#704)", function () {
    ...
    it("array of quantiles matches a full sort for tricky inputs", function () {
        ...
        const cases = [
            {
                x: [
                    31, 16, 67, 56, 16, 12, 79, 13, 3, 37, 41, 68, 3, 52, 88,
                    55, 44, 7
                ],
