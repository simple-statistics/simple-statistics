...
This implementation expects the samples `sampleX` and `sampleY` to be given
...
Produces [sample covariance](http://en.wikipedia.org/wiki/Sample_mean_and_sampleCovariance)
...
_Also available as `.interquartileRange(x)`_
